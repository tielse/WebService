<!DOCTYPE html>
<%@page import="com.chauthoiit.kali.views.AdminHttp"%>
<html lang="en">
...
<title>KST Admin - Bootstrap Admin Template</title>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp">KST Admin</a>
			</div>
			<!-- Top Menu Items -->
			<ul class="nav navbar-right top-nav">
						...
						<li class="message-preview"><a href="#">
								<div class="media">
									<span class="pull-left"> <img class="media-object"
										src="images/50x50.png" alt="">
									</span>
									<div class="media-body">
										<h5 class="media-heading">
											<strong>Ti Root</strong>
										</h5>
				...
				<!--X/ly session-->
				<li class="dropdown"><a href="/Admin/index.jsp"
					class="dropdown-toggle" data-toggle="dropdown"><i
						class="fa fa-user"></i> <%=session.getAttribute("username")%> <b
						class="caret"></b></a>
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="/AdminHttp?command=logout"><i
								class="fa fa-fw fa-power-off"></i> <%=str%> </a></li>
					</ul></li>
			</ul>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					...
					<li><a href="forms.jsp"><i class="fa fa-fw fa-edit"></i>
							Forms</a></li>
					<li><a href="bootstrap-elements.jsp"><i
							class="fa fa-fw fa-desktop"></i> Bootstrap Elements</a></li>
					<li><a href="bootstrap-grid.jsp"><i
					...
					<li><a href="blank-page.jsp"><i class="fa fa-fw fa-file"></i>
							Blank Page</a></li>
					<li><a href="index-rtl.jsp"><i
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="alert alert-info alert-dismissable">
							...
							<i class="fa fa-info-circle"></i> <strong>Like KST
								Admin?</strong> Try out <a href="#" class="alert-link">KST Admin 2</a>
